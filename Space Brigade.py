...
def BattleStart(EnemySheild1, EnemyHp1):
    ...
    EnemyShield = EnemyShield1
    EnemyHp = EnemyHp1

    print("Battle Started:")
    print("    EnemyShield: "+str(EnemyShield))
    print("    EnemyHp: "+str(EnemyHp))

    MainText.configure(text = "Enemy aproaching sir, their shield is at "+str(EnemyShield)+"%.")
...
def BattleMain():
    ...
    if Missed == True:
        ...
        if EnemyHp > 0:
            ...
            if EnemyShield > 0:
                MainText.configure(text = "Positive hit sir, their shield is at "+str(EnemyShield)+"%.")
            else:
                 MainText.configure(text = "Positive hit sir, their hull strength is at "+str(EnemyHp)+"%.")
...
def DamageReport():
    ...
    if Missed == True:
        ...
        if Hp > 0:
            ...
            if Shield > 0:
                MainText.configure(text = "We're hit sir, our shield is at "+str(Shield)+"%.")
            else:
...
def Tutorial_4():
    ...
    Button1.configure(text = "-Begin Battle-", command = BattleStart(100, 100))
    Button2.configure(text = "         ", command = Nothing)
    Button3.configure(text = "         ", command = Nothing)
